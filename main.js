...
onChildAdded(ref(db, "messages"), (data) => {
  if (data.val().sender == sender) {
    messages.innerHTML += "<div style=justify-content:end class=outer id="+data.key+"><div class=header>You</div><br><div id=inner class=me >"+data.val().msg+"</div></div>";
  } else {
    messages.innerHTML += "<div class=outer id="+data.key+"><div class=header>"+data.val().sender+"<br><div id=inner class=notMe >"+data.val().msg+"</div></div>";
  }
})
